...
ALTER TABLE txgen_blocks
    ...
    ADD COLUMN IF NOT EXISTS fcu_ms                Nullable(UInt64) AFTER new_payload_ms,
    ADD COLUMN IF NOT EXISTS server_latency_us     Nullable(UInt64) AFTER fcu_ms,
    ADD COLUMN IF NOT EXISTS persistence_wait_us   Nullable(UInt64) AFTER server_latency_us,
