...
pub use metrics::{
    collect_block_stats, compute_latency_stats, trim_trailing_empty_blocks,
    trim_trailing_empty_blocks_after, BenchMetrics, BlockStats, LatencySample, LatencyStats,
